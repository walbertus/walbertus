...
- [walbertus/learning-ai-agent](https://github.com/walbertus/learning-ai-agent) - Personal learning project about creating ai agent (today)
...
- [simulot/immich-go](https://github.com/simulot/immich-go) ([v0.31.0](https://github.com/simulot/immich-go/releases/tag/v0.31.0), 2 days ago) - An alternative to the immich-CLI command that doesn&#39;t depend on nodejs installation. It tries its best for importing google photos takeout archives.
- [aliyun/terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ([v1.263.0](https://github.com/aliyun/terraform-provider-alicloud/releases/tag/v1.263.0), 4 days ago) - Terraform AliCloud provider
...
- [feat(evaluator): allow using ollama model alongside model garden](https://github.com/gopaytech/rag-pipeline-poc/pull/1) on [gopaytech/rag-pipeline-poc](https://github.com/gopaytech/rag-pipeline-poc) (1 day ago)
